...
public class MekanismModRegistry extends ModuleRegistry {

    @SubscribeEvent
    public static void registerRecipes(RegistryEvent.Register<IRecipe> event) {
        if(MekanismConfig.sawmillRecipes) {
            sawMillRecipes();
        }
        if(MekanismConfig.crusherRecipes) {
            crusherRecipes();
        }
        if(MekanismConfig.evaporationRecipes) {
            evaporationRecipes();
        }
    }
