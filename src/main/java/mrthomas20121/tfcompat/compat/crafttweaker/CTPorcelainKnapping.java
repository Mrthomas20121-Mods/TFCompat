...
public class CTPorcelainKnapping {
    ...
    public static void addRecipe(String registryName, IItemStack output, String... pattern)
    {
        ...
        KnappingRecipe recipe = new KnappingRecipeSimple(Types.PORCELAIN, true, outputStack, pattern).setRegistryName(registryName);
        CraftTweakerAPI.apply(new IAction()
        {
            ...
            public String describe()
            {
                ...
                return "Adding Porcelain knapping recipe " + recipe.getRegistryName().toString();
            }
        });
    }
    ...
    public static void removeRecipe(IItemStack output)
    {
        ...
        TFCRegistries.KNAPPING.getValuesCollection()
                .stream()
                .filter(x -> x.getType() == Types.PORCELAIN && x.getOutput(ItemStack.EMPTY).isItemEqual(item))
        ...
        for (KnappingRecipe rem : removeList)
        {
            CraftTweakerAPI.apply(new IAction()
            {
                ...
                {
                    //noinspection ConstantConditions
                    return "Removing Porcelain knapping recipe " + rem.getRegistryName().toString();
                }
            });
        }
    }
    ...
    public static void removeRecipe(String registryName)
    {
        ...
        if (recipe != null)
        {
            CraftTweakerAPI.apply(new IAction()
            {
                ...
                {
                    //noinspection ConstantConditions
                    return "Removing Porcelain knapping recipe " + recipe.getRegistryName().toString();
                }
            });
        }
    }
